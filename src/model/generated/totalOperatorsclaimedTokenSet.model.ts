...
@Entity_()
export class TotalOperatorsclaimedTokenSet {
    constructor(props?: Partial<TotalOperatorsclaimedTokenSet>) {
    ...
    @StringColumn_({nullable: true})
    oldAmount!: string | undefined | null

    @StringColumn_({nullable: true})
    newAmount!: string | undefined | null
