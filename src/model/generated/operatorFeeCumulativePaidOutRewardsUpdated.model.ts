...
@Entity_()
export class OperatorFeeCumulativePaidOutRewardsUpdated {
    constructor(props?: Partial<OperatorFeeCumulativePaidOutRewardsUpdated>) {
    ...
    @BigIntColumn_({nullable: true})
    cumulativeFeePaidOutRewards!: bigint | undefined | null
