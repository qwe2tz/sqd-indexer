...
@Entity_()
export class TokenEmissionMultiplierUpdateFinalized {
    constructor(props?: Partial<TokenEmissionMultiplierUpdateFinalized>) {
    ...
    @StringColumn_({nullable: true})
    oldMultiplier!: string | undefined | null

    @StringColumn_({nullable: true})
    newMultiplier!: string | undefined | null
