...
@Entity_()
export class ParanetPermissionedMinerAccessRequestRejected {
    constructor(props?: Partial<ParanetPermissionedMinerAccessRequestRejected>) {
    ...
    @StringColumn_({nullable: true})
    minerAddress!: string | undefined | null
}
