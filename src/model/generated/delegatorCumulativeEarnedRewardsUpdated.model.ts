...
@Entity_()
export class DelegatorCumulativeEarnedRewardsUpdated {
    constructor(props?: Partial<DelegatorCumulativeEarnedRewardsUpdated>) {
    ...
    @BigIntColumn_({nullable: true})
    cumulativeEarnedRewards!: bigint | undefined | null
