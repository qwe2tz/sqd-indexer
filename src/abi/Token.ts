...
export const functions = {
    ...
    'grantRole(bytes32,address)': fun("0x2f2ff15d", "grantRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    'grantRole(address)': fun("0x38977686", "grantRole(address)", {"minter": p.address}, ),
...
export type GrantRoleParams_0 = FunctionArguments<typeof functions['grantRole(bytes32,address)']>
export type GrantRoleReturn_0 = FunctionReturn<typeof functions['grantRole(bytes32,address)']>

export type GrantRoleParams_1 = FunctionArguments<typeof functions['grantRole(address)']>
export type GrantRoleReturn_1 = FunctionReturn<typeof functions['grantRole(address)']>
